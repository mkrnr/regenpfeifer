        ...
        for word in dictionary_generator.words:
            ...
            if len(strokes_list) == 0:
                unmatched_log_entry = (
                    ...
                    + word_type
                    + ": "
                    + word_emphasizer.emphasize(word, word_type)
                    + " - "
                    + "/".join(word_splitter.split(word))
                )
            ...
            if i % 100 == 0:
                ...
                stats_line = (
                    ...
                    + str(i)
                    + " of "
                    + str(len(dictionary_generator.words))
                    + " words - "
                    + str(unmatched_count)
                    + " not matched - "
                    + str(duplicate_count)
