...
class TestWordPatternMatcher(unittest.TestCase):
    ...
    def test_easy_words(self):
        ...
        self.assertEqual(self.word_pattern_matcher.match('g[e|a]nz'), '[TKPW][e|A][-PB][-S]*')

    def test_disambiguations(self):
        self.assertEqual(self.word_pattern_matcher.match('s[e|ei]nen'), '[S][e|AEU][-PB][-N]')
    ...
    def test_prefixes(self):
        self.assertEqual(self.word_pattern_matcher.match('verg[e|e]ht'), '[SR][e|E][-R]/[TKPW][e|E][-T]')
